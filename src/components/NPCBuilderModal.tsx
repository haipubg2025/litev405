      ...
      properties: {
        newNPCs: {
          ...
          items: {
            ...
            required: ["name", "fullName", "titles", "occupation", "role", "background", "gender", "age", "dob", "rank", "height", "weight", "measurements", "appearance", "appearanceLite", "personality", "personalityCore", "philosophy", "goal", "distinguishingFeatures", "innerSecret", "relationships", "loveViews", "experience", "nsfwPersonality", "nsfwReactions", "literaryDescription"]
          }
        }
      },
      required: ["newNPCs"]
...
- ĐẶC BIỆT LƯU Ý VÀ CẤM KỴ: Khi viết vào phần "appearance", AI PHẢI TỰ SUY LUẬN TỪ CÁC THÔNG SỐ (chiều cao, cân nặng, số đo 3 vòng, cup ngực) SAU ĐÓ CHUYỂN HÓA THÀNH TỪ NGỮ MIÊU TẢ VĂN CHƯƠNG, TUYỆT ĐỐI KHÔNG ĐƯỢC CHÈN/BÊ NGUYÊN CÁC CON SỐ KHÔ KHAN NÀY VÀO. Đối với phần 'appearanceLite', BẮT BUỘC phải viết tóm tắt của 'appearance' thật cô đọng nhưng phải có ít nhất 5 CÂU MÔ TẢ ĐẦY ĐỦ VỀ CƠ THỂ BỀ NGOÀI, VÀ ĐẶC BIỆT 'appearanceLite' CHỈ CÓ NỘI DUNG SFW VÀ KHÔNG HỀ KÈM THEO TRANG PHỤC. CẢNH BÁO TỐI THƯỢNG: Việc miêu tả ngoại hình trần trụi, nhạy cảm TUYỆT ĐỐI KHÔNG ĐƯỢC phép làm biến chất tính cách của nhân vật. Nếu NPC được thiết lập là đoan trang, lạnh lùng hay nghiêm túc, phải GIỮ VỮNG 100% khí chất đó. KHÔNG ĐƯỢC dùng tiếng lóng "cup ngực", "cỡ D" trong văn miêu tả "appearance".
...
- height: Chiều cao
- weight: Cân nặng
- measurements: Số đo 3 vòng kèm cup nếu là Nữ (BẮT BUỘC CHỈ GHI SỐ, VD: 90-60-90 (Cup D), Cấm ghi dòng chữ miêu tả)
- appearance: Ngoại hình cực kỳ chi tiết, đường cong cơ thể, lối ăn mặc.
- appearanceLite: Tóm tắt ngắn gọn ngoại hình (5 câu trở lên, chỉ SFW, không kèm trang phục).
...
- personality: Tính cách biểu hiện
- personalityCore: Cốt lõi tính cách thật sự
- philosophy: Triết lý/Nhân sinh quan
- distinguishingFeatures: Đặc điểm nhận dạng đặc biệt
- innerSecret: Bí mật thầm kín, yếu điểm
- relationships: Danh sách các tương quan (Mảng object [{name, relation, status, description}]). (NGUYÊN TẮC: TUYỆT ĐỐI KHÔNG TẠO QUAN HỆ VỚI KHÁCH THỂ CHƯA XUẤT HIỆN. Để trống mảng nếu không quen ai).
...
- literaryDescription: Chân dung văn học giàu cảm xúc theo kiểu SFW
  ...
  "newNPCs": [
    {
      ...
      "relationships": [{ "name": "Tên", "relation": "Quan hệ", "status": "Trạng thái", "description": "Mô tả" }],
